<div class="ring-1 ring-vibrant-primary/30 rounded-sm">
    <div
        class="group relative
               ...
               rounded-sm rounded-b-0
               overflow-hidden bg-dark-primary shadow-lg
        ...
        <div
            ...
            <p
                class="mt-2 text-gray-300
                       ...
                       leading-[1.4] line-clamp-2  group-hover:line-clamp-none transition-all duration-1000">
                {{ $foodMenu->short_description }}
            </p>
        </div>
    </div>
    <button onclick="openRatingModal('{{ $foodMenu->id }}', '{{ $foodMenu->name }}')"
        class="w-full bg-white/10 backdrop-blur-md rounded-b-sm 
