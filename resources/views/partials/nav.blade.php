<nav class="bg-[#0A0A0A] fixed w-full z-20 top-0 start-0 border-vibrant-primary">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-xl text-vibrant-primary font-semibold whitespace-nowrap">Flowbite</span>
        </a>
        <div class="inline-flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <button data-collapse-toggle="navbar-cta" type="button"
                class="inline-flex items-center p-2 w-9 h-9 justify-center text-sm text-vibrant-primary rounded-base md:hidden hover:bg-black hover:text-heading focus:outline-none focus:ring-2 focus:ring-neutral-tertiary"
                aria-controls="navbar-cta" aria-expanded="false">
                <span class="sr-only">Open main menu</span>
                <svg class="w-6 h-6 text-vibrant-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
